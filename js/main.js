...
x is a local variable as claimed.
y is NOT a global variable as claimed.
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) prints "undefined" since declarations are not hoisted

console.log( foo() ) prints "function hoisting" since functions are hoisted
...
console.log(add) inside the function will print 4
console.log(add) outside the function will return undefined
...
(function(){
  "use strict";
   var birthday = new Date("April 21, 1983");
...
(function(){
  ...
  console.assert(true, "#6 Test Failed. Did you set stringDate correctly?")
})();
...
-It should return: "Hello James. Here is the status of your account. Thank you for your loyalty. You've been a member for 18 months . Your next bill will reflect a $50 credit and a 5% discount going forward."
HINTS:
